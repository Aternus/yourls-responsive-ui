...
export function initDesktopRowDrawers() {
    ...
    const renderEditContent = (data) => {
        ...
        editor.className = "responsive-inline-editor responsive-drawer-editor";
    ...
    const renderShareContent = (data) => {
        ...
        actions.append(copyButton, twitterButton, facebookButton, closeButton);
    ...
    window.edit_link_save = function (id) {
        if (!isDesktop() || state.mode !== "edit" || state.id !== String(id)) {
