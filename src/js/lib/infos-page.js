    ...
    if (tabsHeader instanceof HTMLElement) {
        ...
        const updateHeaderPill = () => {
            ...
            if (!(selected instanceof HTMLElement)) {
                tabsHeader.style.setProperty("--responsive-pill-width", "0px");
                return;
            }
            ...
            tabsHeader.style.setProperty("--responsive-pill-left", `${left}px`);
