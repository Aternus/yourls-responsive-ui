...
export function initDeleteConfirmDialog() {
    ...
    if (!(dialog instanceof HTMLElement) || !(message instanceof HTMLElement)) {
        return;
    }
    ...
    mountVueFeature(
        dialog,
        "ResponsiveDeleteConfirmFeature",
        "responsiveDeleteConfirm",
        () => {
            if (
                ...
                headingText.className =
                    "responsive-delete-confirm-heading-text";

                const headingSpan = document.createElement("span");
                headingSpan.className =
                    "responsive-delete-confirm-heading-title";
            ...
            if (
                ...
                introTitle.textContent =
                    "Review the link details before deleting.";
            ...
            if (buttonGroup instanceof HTMLElement) {
                ...
                const deleteControl =
                    buttonGroup.querySelector("input.primary");
                ...
                makeButton({
                    ...
                    onClick: () => {
                        if (
                            typeof window.remove_link_confirmed === "function"
                        ) {
